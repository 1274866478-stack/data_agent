"""
Query optimization helpers for RAG-SQL domain.

Provides in-memory TTL cache, query profiling, and aggregation utilities
used by document/query listing APIs.
"""
...
class QueryOptimizationService:
    ...
    def __init__(self):
        ...
        self.cache_ttl_seconds = {
            ...
            QueryType.TREND_ANALYSIS: 3600     # 1С?
