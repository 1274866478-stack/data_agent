...
## [POS]
**路径**: backend/src/app/domains/reasoning_service.py
**模块层级**: Level 1 (服务层)
...
class EnhancedReasoningEngine:
    ...
    def fusion_engine(self):
        ...
        if self._fusion_engine is None:
            from src.app.domains.reasoning.fusion_service import fusion_engine
    ...
    def xai_service(self):
        ...
        if self._xai_service is None:
            from src.app.domains.reasoning.xai_service import xai_service
