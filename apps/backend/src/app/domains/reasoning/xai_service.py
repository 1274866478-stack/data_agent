"""XAI service for transparent answer explanations.

Builds explanation steps, source traces, uncertainty metrics, and decision-tree
data for answers produced by the fusion pipeline.
"""
...
from src.app.domains.reasoning.fusion_service import FusionResult, ConflictInfo
    ...
    async def _explain_reasoning_process(
        ...
        try:
            ...
            return ExplanationStep(
                ...
                evidence=evidence,
                confidence=0.8,
                reasoning="基于查询复杂度和数据源信息，选择最适合的推理策略",
