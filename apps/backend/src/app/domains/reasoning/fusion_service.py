"""Fusion engine for multi-source reasoning output.

This module standardizes heterogeneous inputs (SQL/RAG/documents), detects and
resolves conflicts, then synthesizes a final answer plus explanation metadata.
"""
...
class DataFusionEngine:
    ...
    async def fuse_multi_source_data(
        ...
        try:
            ...
            used_fusion_strategy = fused_content.get("fusion_strategy", "default")
