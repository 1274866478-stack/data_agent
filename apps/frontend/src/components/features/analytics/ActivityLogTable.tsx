 ...
 *
 * [LINK]
 * - 使用路径: @/components/features/analytics/ActivityLogTable
 * - 配套组件: DonutChart, EmptyDocumentState
 *
 * [POS]
 * - 文件路径: frontend/src/components/features/analytics/ActivityLogTable.tsx
 *
 * [STATE]
 * - 无状态组件
 *
...
import type { ActivityLog, ActivityStatus } from '@/types/components/analytics'

/**
 * 活动日志状态类型
 */
export type { ActivityLog, ActivityStatus }
